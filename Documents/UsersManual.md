...
* _Database Access_: The built in library helps you to implement the application which requires database access.
...
````
/* Setup and authorize contact database access */
if(setupContacts()){
        /* Print the number of contact records */
...
and [sample script](https://github.com/steelwheels/JSTerminal/blob/master/Resource/Sample/contact.js).
