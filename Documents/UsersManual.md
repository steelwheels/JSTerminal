...
* _Database Access_: The built in library helps you to implement the application which requires database access. Now, the [contact database](https://developer.apple.com/documentation/contacts) access is supported.
...
* [Database](#Database): Database programming
...
This is sample program of data structure viewer.
````
jsh> run Sample/value1.jspkg
````
And you will get following outputs:
![Screenshot of value1.jspkg](./Images/value-view-1.png)
